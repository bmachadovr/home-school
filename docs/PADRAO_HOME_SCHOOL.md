# Home School — Padrão de Elaboração das Páginas
...
## 4. Estrutura padrão de uma jornada

Cada aula deve funcionar em **carrossel/slides**, com conteúdo dividido em páginas curtas.
...
3. Treino guiado: 8–10 min
4. Produção ativa: 8–10 min
...
Toda jornada deve ser apresentada como um grande jogo de estudo.
...
## 9. Aprendizagem ativa e repetição
...
A tela final deve mostrar, quando possível:
...
- textos curtos;
- cores consistentes por matéria;
...
- [ ] Desafio final
- [ ] Tela de resultado
- [ ] Diagnóstico por assunto, quando aplicável
- [ ] Responsividade no celular
- [ ] Respostas e correções testadas
