...
- Filosofia foi iniciada para o 3º bimestre com duas revisões interativas em validação. A Revisão 1 prioriza construção didática dos capítulos 5 e 6, com exemplos práticos, dicas, jogos e exercícios. A Revisão 2 prioriza reta final, conexões rápidas, situações-problema, pegadinhas com termos absolutos e treino de questões. Os arquivos estão publicados no repositório em `filosofia/3-bimestre-v2/revisao-1/` e `revisao-2/`, mas Filosofia permanece deliberadamente sem link na Home até validação final do conteúdo e da experiência.
