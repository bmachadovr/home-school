...
- Matemática foi iniciada com a Revisão 1 do 3º bimestre em formato de jogo investigativo “Os Casos da Detetive Jujuba — O Mistério do Cofre Impossível”. O protótipo jogável foi expandido para 21 telas, com progressão em atos, desafios de inequações, teste de valores e limites, elementos e comprimento da circunferência, áreas de figuras planas e decomposição, feedback imediato e persistência local. Matemática aparece na página raiz do portal, mas o link da Revisão 1 está desabilitado enquanto o conteúdo permanece em desenvolvimento, evitando acesso indevido. A direção aprovada é expandir o caso para até aproximadamente 50 telas, mantendo narrativa e matemática integradas e usando ilustrações como cenários/elementos do HTML, não como páginas estáticas.
